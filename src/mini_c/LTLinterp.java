...
public class LTLinterp  implements LTLVisitor {
  ...
  public void visit(Lmbinop o) {
    // System.out.println(o);
    // System.out.println("rsp = " +get(Register.rsp));
    // System.out.println("rbp = " +get(Register.rbp));
    long v1 = get(o.o1);
    if (o.m == Mbinop.Mmov)
      set(o.o2, v1);
    else {
 ...
 @Override
  public void visit(Lpush o) {
    ...
    // System.out.println("Ap rsp = " +get(Register.rsp));
    // System.out.println("Ap rbp = " +get(Register.rbp));
    this.next = o.l;
  }
